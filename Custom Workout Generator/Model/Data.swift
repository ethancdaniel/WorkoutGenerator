...
class Data {
    let exercises = [Exercise(name: "Bench Press", parts: [Parts.chest], isCompound: true, imageName: "benchPress"),
                     ...
                     Exercise(name: "Zercher Squat", parts: [Parts.quadriceps], isCompound: false, imageName: "zercherSquat"),
                     Exercise(name: "Goblet Squat", parts: [Parts.quadriceps], isCompound: false, imageName: "gobletSquat"),
